...
def _convert_prompt_message_to_dict(message: PromptMessage) -> dict:
    ...
    elif isinstance(message.content, AssistantPromptMessage):
        message = cast(AssistantPromptMessage, message)
        message_dict = {"role": "assistant", "content": message.content}
    elif isinstance(message.content, SystemPromptMessage):
    ...
    elif isinstance(message.content, ToolPromptMessage):
